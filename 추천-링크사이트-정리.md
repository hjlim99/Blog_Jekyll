...
* [기타 모음 링크](https://github.com/GunhoChoi/Kind_Tensorflow101/tree/master)
* [ppt:제로부터 시작하는 텐서플로우](http://www.slideshare.net/hephaex/kosscon-68524615)
* [ppt:나만의 모델을 만들자](http://www.slideshare.net/carpedm20/ss-63116251)
...
* [Read the Docs](https://readthedocs.org/) : 호스팅 서비스(외부툴 이용 글 작성 필요)
* [GitBook](https://www.gitbook.com) : Markdown 기반 
* [BookDown](https://bookdown.org/) : R Studio / RMarkdown 기반 
* [WikiDocs](https://wikidocs.net/) : (한글) 온라인 저작 플랫폼, 무료책 참고 가능
...
* [Math Fun](http://www.mathsisfun.com/)
...
* [빅콘테스트](http://contest.kbig.kr/) : 한국 정보화 진흥원 주최